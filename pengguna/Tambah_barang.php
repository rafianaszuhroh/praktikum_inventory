...
if (isset($_POST['submit'])) {
    ...
    $status     = mysqli_real_escape_string($koneksi, $_POST['status_id']);
    $penyimp    = mysqli_real_escape_string($koneksi, $_POST['penyimpanan_id']);
    $harga      = intval($_POST['harga']);
    $stok_awal  = intval($_POST['stok']);
    $limit_stok = intval($_POST['limit_stok']);
    $vendor_id  = intval($_POST['vendor_id']);

    // Query INSERT dengan nama kolom yang sesuai struktur tabel barang
    $query_insert = "INSERT INTO barang 
                 (nama_barang, status_id, penyimpanan_id, harga_barang, stok, limit_stok, vendor_id) 
                 VALUES 
                 ('$nama', '$status', '$penyimp', '$harga', '$stok_awal', '$limit_stok', '$vendor_id')";
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" class="form-control" placeholder="Contoh: Keyboard Logi" required>
                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="status_id" class="form-select" required>
                                        ...
                                        <?php while ($st = mysqli_fetch_assoc($query_status)) { ?>
                                            <option value="<?= htmlspecialchars($st['nama_status']); ?>">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="penyimpanan_id" class="form-select" required>
                                        ...
                                        <?php while ($pny = mysqli_fetch_assoc($query_penyimpanan)) { ?>
                                            <option value="<?= htmlspecialchars($pny['nama_penyimpanan']); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="limit_stok" class="form-control" value="5" min="1" required>
                                    <div class="form-text text-muted">Batas peringatan kritis warna merah di dashboard.</div>
                                </div>
                            </div>
